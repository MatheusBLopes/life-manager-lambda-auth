...
LAMBDA_FUNCTION_NAME="LifeManagerLambdaAuth"
LAMBDA_DIR="./app"
ZIP_FILE="lambda_auth.zip"
TEMP_DIR="lambda_temp"
ALIAS_NAME="prod"
API_NAME="life-manager-api"
REGION="us-east-1"
AWS_ACCOUNT_ID="880587150218"
S3_BUCKET_NAME="life-manager-lambdas-deploy"
...
integrate_api_gateway "/login" "POST"
